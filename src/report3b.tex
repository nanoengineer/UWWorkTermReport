...
\subsection{Flight minimum altitude of 150 meters (outside of typical BLE range)}
	...
	\begin{figure}[!tbp]
	\centering
	\subfloat[Hatch Open.]{\includegraphics[width=5cm]{./images/open_hatch.png}\label{fig:open_hatch}}
	\hfill
	\subfloat[Hatch Closed.]{\includegraphics[width=5cm]{./images/closed_hatch.png}\label{fig:closed_hatch}}
	...
	\begin{figure}[!tbp]
	\centering
	\subfloat[3D Model.]{\includegraphics[width=6cm]{./images/3d_model.png}\label{fig:3d_model}}
	\hfill
	\subfloat[Assembled Rocket.]{\includegraphics[width=4cm]{./images/rocket.jpg}\label{fig:rocket}}
	\caption{Parachute Hatch 3D Model.}
	\end{figure}
